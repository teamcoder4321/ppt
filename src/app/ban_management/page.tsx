...
import GeneratedBanManagementDashboardLinkView from '../../views/ban_management_dashboard_link';
import GeneratedAdminDashboardMenuView from '../../views/admin_dashboard_menu';
import GeneratedUserBanCheckerView from '../../views/user_ban_checker';
...
export const metadata: Metadata = { title: "Ban Management", description: "Check user ban status and manage account restrictions" };
      ...
      <main>
                    ...
                    <div className="h-full grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ backgroundColor: 'transparent', paddingLeft: '25px', paddingTop: '12px', paddingBottom: '8px', marginTop: '8px', marginBottom: '8px' }}>
                            <GeneratedBanManagementDashboardLinkView isContainer={false} />
                        </div>
                    </div>
