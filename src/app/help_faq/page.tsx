...
import GeneratedFrequentlyAskedQuestionsView from '../../views/frequently_asked_questions';
...
export const metadata: Metadata = { title: "Help & FAQ", description: "Frequently asked questions and helpful guides for using Synapse" };
      ...
      <main>
                    ...
                    <div className="h-full grid grid-cols-12 relative">
                        <div className="h-full w-full col-span-12 md:col-span-12 lg:col-span-12" style={{ paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', paddingBottom: '20px', alignContent: 'start', textAlign: 'left' }}>
                            <GeneratedFrequentlyAskedQuestionsView isContainer={false} />
                        </div>
                    </div>
