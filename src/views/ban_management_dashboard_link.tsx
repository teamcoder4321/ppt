...
interface GeneratedBanManagementDashboardLinkViewProps {
  isContainer?: boolean;
}

export default function GeneratedBanManagementDashboardLinkView({ isContainer = false }: GeneratedBanManagementDashboardLinkViewProps){
  return (
